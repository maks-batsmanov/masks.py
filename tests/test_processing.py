...
def test_filter_by_state_01(list_of_dict_for_tests):
    assert filter_by_state(list_of_dict_for_tests) == [
        {'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
        {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'}
    ]

def test_filter_by_state_02(list_of_dict_for_tests):
...
def test_filter_by_state_03(list_of_dict_for_tests):
    assert filter_by_state(list_of_dict_for_tests, state = '') == 'Такого ключа нет'


def test_sort_by_date_01(list_of_dict_for_tests):
...
def test_sort_by_date_02(list_of_dict_for_tests):
...
def test_sort_by_date_03(list_of_dict_same_date):
